...
class ProfilePostsThreePage extends StatefulWidget {
  const ProfilePostsThreePage({Key? key})
      : super(
          key: key,
        );

  @override
  ProfilePostsThreePageState createState() => ProfilePostsThreePageState();
}

class ProfilePostsThreePageState extends State<ProfilePostsThreePage>
    with AutomaticKeepAliveClientMixin<ProfilePostsThreePage> {
  @override
