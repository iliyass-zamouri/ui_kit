import '../market_two_screen/widgets/contentmarketbl1_item_widget.dart';
import '../market_two_screen/widgets/contentmarketbl2_item_widget.dart';
import '../market_two_screen/widgets/contentmarketbl_item_widget.dart';
...
class MarketTwoScreen extends StatelessWidget {
  MarketTwoScreen({Key? key})
      : super(
          key: key,
        );
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return ContentmarketblItemWidget();
                            },
                          ),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: ListView.separated(
                            ...
                            itemCount: 4,
                            itemBuilder: (context, index) {
                              return Contentmarketbl1ItemWidget();
                            },
                          ),
                        ),
                        SizedBox(height: 31.v),
                        ...
                        SizedBox(
                          ...
                          child: ListView.separated(
                            ...
                            itemCount: 3,
                            itemBuilder: (context, index) {
                              return Contentmarketbl2ItemWidget();
                            },
                          ),
                        ),
                      ],
