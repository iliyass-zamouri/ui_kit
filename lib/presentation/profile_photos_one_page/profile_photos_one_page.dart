...
class ProfilePhotosOnePage extends StatefulWidget {
  const ProfilePhotosOnePage({Key? key})
      : super(
          key: key,
        );

  @override
  ProfilePhotosOnePageState createState() => ProfilePhotosOnePageState();
}

class ProfilePhotosOnePageState extends State<ProfilePhotosOnePage>
    with AutomaticKeepAliveClientMixin<ProfilePhotosOnePage> {
  @override
